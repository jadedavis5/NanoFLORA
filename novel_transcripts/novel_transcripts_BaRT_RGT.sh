...
#Find transcripts with less than 5 reads mapping
#singularity run $isoquant isoquant.py --reference $genome --genedb RGT_Planet_NBS.gtf \
#--data_type nanopore -o NBS_ISOQUANT --no_model_construction -t 256 --matching_strategy precise \
