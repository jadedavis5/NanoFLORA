...
def main(input_summary, input_coding_potential, input_type_ss, output_path):
    ...
    additional_data_1 = read_additional_file(input_coding_potential)
    additional_data_2 = read_additional_file(input_type_ss)
...
if __name__ == '__main__':
    ...
    main(args.input_summary, args.input_coding_potential, args.input_type_ss, args.output)
